...
import frame2 from '../components/assets/frame2.png'
 const Home = (props) => {
  return (
    <section className={` relative  visible text-white poppins h-[76vh] flex flex-col justify-center pl-[20px] ${props.change==0?'visible fadein-transition':'fadeout-transition hidden'}`}>
