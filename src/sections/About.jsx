        ...
        <section className="flex space-x-20 max-lg:space-x-0 max-lg:space-y-20 w-[80vw] mx-auto mt-[7rem] mb-[3rem] max-lg:flex-col max-lg:mx-auto ">
          ...
          <section className='w-[100%] '>
            <p className="text-justify text-[22px] leading-[35px] max-lg:leading-[33px] max-lg:text-[18px] max-[400px]:text-[15px] mb-10">
              ...
              In free time I post my learning on <a href=' ' className="text-[#f6bd2e] hover:text-[#d09500] text-[25px] max-lg:text-[21px] max-[400px]:text-[17px]">Twitter</a> and also write some blogs on Web Development and core programming concepts on <a href=' ' className="text-[#f6bd2e] hover:text-[#d09500] text-[25px] max-lg:text-[21px] max-[400px]:text-[17px]">Hashnode</a> and <a href=' ' className="text-[#f6bd2e]  hover:text-[#d09500] text-[25px] max-lg:text-[21px] max-[400px]:text-[17px]">Medium</a>.
            </p>
            <a
              href={cv}
              download
